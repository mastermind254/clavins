                            ...
                            <div class="limit-box">
                                <nav class="main-menu">
                                    <ul class="menu-area-main">
                                        <li class="active"> <a href="index.html">ShopNow</a> </li>
                                        <li> <a href="/about">Blogs</a> </li>
                                        <li><a href="brand.html">Travel&Tours</a></li>
                                        
                                        <li><a href="contact.html">Contact Us</a></li>
                                        
                                        <li><a href="login">GetStarted</a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="carousel-item active">
                    ...
                    <div class="container">
                        <div class="carousel-caption relative">
                            <span>New Clad Style In Town</span>
                            <h1>UPTO 50% OFF MEN'S FASHION</h1>
                            <p>It about the man and the style of dressing at Clavins cosmetic Site.
                                <br> Making our costomer to experince the best vasion of themselves.</p>
